...
const Card = ({ constraint, data }) => {
      ...
      return (
            <motion.div ref={card} className="lg:min-w-52 rounded-2xl lg:min-h-60 min-w-32 min-h-40 cursor-grab relative font-[Roboto]  shrink-0 p-4 backdrop-blur-md bg-[var(--card)]/30" drag dragTransition={{ bounceStiffness: 600, timeConstant: 1000, bounceDamping: 10, power: 1 }} dragElastic={1} whileDrag={{ scale: 1.1, zIndex: 9999999 }} dragConstraints={constraint}>
